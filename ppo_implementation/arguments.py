def get_args(parser):
    ...
    parser.add_argument('--training_iterations', type=int, default=400, help='number of training iterations')
    ...
    # Path Based Args
    parser.add_argument('--tensorboard_dir', type=str, default="runs/ppo-5-episodes", help='Directory path to use for TensorBoard')
    parser.add_argument('--test_model_path', type=str, default="checkpoints/ppo_model_final_attnsk.pth", help='File path to use for loading testing model')
    parser.add_argument('--save_model_dir', type=str, default="checkpoints/ppo_5_episodes", help='Directory path to use for saving training model weight checkpoints')

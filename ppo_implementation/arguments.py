def get_args(parser):
    ...
    parser.add_argument('--test_model_path', type=str, default="checkpoints/ppo_model_final_attn.pth", help='File path to use for loading testing model')
    parser.add_argument('--save_model_dir', type=str, default="checkpoints/ppo_5_episdoes", help='Directory path to use for saving training model weight checkpoints')

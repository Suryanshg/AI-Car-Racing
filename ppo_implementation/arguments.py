def get_args(parser):
    ...
    # Path Based Args
    parser.add_argument('--tensorboard_dir', type=str, default="runs/ppo-10-episodes", help='Directory path to use for TensorBoard')
    ...
    parser.add_argument('--save_model_dir', type=str, default="checkpoints/ppo_10_episdoes", help='Directory path to use for saving training model weight checkpoints')

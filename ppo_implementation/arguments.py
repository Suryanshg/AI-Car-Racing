def get_args(parser):
    ...
    # Path Based Args
    parser.add_argument('--tensorboard_dir', type=str, default="runs/ppo-wt-init", help='Directory path to use for TensorBoard')
    ...
    parser.add_argument('--save_model_dir', type=str, default="checkpoints/ppo_wt_init", help='Directory path to use for saving training model weight checkpoints')
